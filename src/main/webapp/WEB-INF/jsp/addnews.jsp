        ...
        <div class="my-col-md-12">
            <div class="sub_cont">
                ...
                <form action="addnews" method="post">
                    <input type="text" placeholder="请输入标题" name="title" prepared>
                    <input type="text" placeholder="请输入内容" name="content" prepared>
                    <input type="text" placeholder="请输入地址" name="url" prepared>
