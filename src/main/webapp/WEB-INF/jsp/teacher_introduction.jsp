...
<!--老师详细介绍-->
<div class="my-container" style="height: 120%">
    <div class="my-area my-row">
        <div style="display: flex" class="my-col-md-12">
            <!--导师介绍-->
            <div class="my-col-md-12 " style="margin: 10px 100px;">
                <div class="card">
                    <div class="card-header">
                        <img src="${pageContext.request.contextPath}${teacher.photoUrl}" alt="" />
                    </div>
                    <div class="card-content">
                        <p>
                        ${teacher.introduceText}
                        </p>
                    </div>
