    ...
    <div class="my-area my-row">
        <div class="my-col-md-12">
            <div class="sub_cont">
                ...
                <hr>
                <div>
                    <p style="text-indent: 2em;"> 实验室以国内外计算机科学技术领域提出的基本问题为背景，面向国家发展软件产业和国家安全的战略需求，开展计算机科学理论和软件基础研究。
                    <p style="text-indent: 2em;">软件系统原理及开发方法： 研究程序设计语言的基础理论，探索软件可靠性开发的新框架和新方法，研究面向各种并发程序的分析、验证和测试方法，开发相应的辅助工具，并结合应用实例的研究，提高算法及工具的效率和性能。研究基础软件核心技术，研制国产操作系统、中间件和数据库，形成基础软件平台体系，实现我国基础软件产品的自主可控。突破高安全可信、国产软硬件优化适配等操作系统核心关键技术；突破新一代中间件关键技术，为海云计算和物联网提供运行支撑；突破大规模分布式实时主动数据库关键技术，开发分布式实时主动数据库系统。</p>
                    <p style="text-indent: 2em;">软件系统原理及开发方法： 研究程序设计语言的基础理论，探索软件可靠性开发的新框架和新方法，研究面向各种并发程序的分析、验证和测试方法，开发相应的辅助工具，并结合应用实例的研究，提高算法及工具的效率和性能。研究基础软件核心技术，研制国产操作系统、中间件和数据库，形成基础软件平台体系，实现我国基础软件产品的自主可控。突破高安全可信、国产软硬件优化适配等操作系统核心关键技术；突破新一代中间件关键技术，为海云计算和物联网提供运行支撑；突破大规模分布式实时主动数据库关键技术，开发分布式实时主动数据库系统。 </p></div></div>
