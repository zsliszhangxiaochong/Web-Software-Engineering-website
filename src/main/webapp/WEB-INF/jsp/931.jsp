        ...
        <div class="my-area my-row">
            <div class="my-col-md-12">
                <div class="sub_cont">
                    ...
                    <hr>
                    <div>
                        <p style="text-indent: 2em;"> 软件开发环境国家重点实验室是国家在计算机和先进网络的软件理论、技术和开发环境等方面开展基础、应用基础与前沿高技术研究的开放式科研基地，是创新型高层次人才的培养基地。1988年通过专家论证，1995年通过专家验收。
                        <p style="text-indent: 2em;">始终服务国家战略和围绕信息科学的前沿方向，积极争取和承担国家关键项目，开展原创性的基础研究和创新性的技术突破，成为软件开发理论与方法以及群体软件工程研究的开拓者和国际一流的海量信息系统和网络计算的创新基地；努力成为现代物理学国际协作研究的海量数据分析和处理中心之一；服务于国家重大专项和国民经济建设的主战场，支撑国家科技基础条件平台的研发与服务，建成中国物联网技术研发和推广的促进中心；大力培养高层次网络化软件领军人才。
                        <p style="text-indent: 2em;">实验室始终瞄准国家战略需求和国际软件发展前沿，针对我国在软件领域发展的战略需求和国际研究趋势，在软件基础理论与方法论、网络海量信息的物理学特征、海量非结构化数据模型与管理系统、物联网软件支撑技术与系统、面向服务的软件开发运行环境和多媒体协同网络环境等方面开拓创新。
                    </div>
                </div>
